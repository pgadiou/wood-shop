---
description: >-
  From a smart action form which asks input for 3 new products at a time
  (picture + description), catch the posted payload and create 3 products
---

# Create a record from input form
